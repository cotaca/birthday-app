  ...
  return (
    <>
        ...
        {characters.map((character) => {
            if (!character?.media?.nodes) return <p>Ungültige Character-Daten erhalten.</p>;

            const origin = character.media.nodes.map((node) => node?.title?.romaji ?? "")
            ...
            return (
                <div style={{
                    ...
                    <div>
                        ...
                        <p><b>Alter:</b> {character.age ?? "Unbekannt"}</p>
                        <p><b>Geschlecht:</b> {character.gender ?? "Unbekannt"}</p>
                        <p><b>Herkunft:</b> {origin.join(", ")}</p>
                    </div>
                    <img
